...
public static class StateListExtensions
{
	...
	/// <returns></returns>
	public static Piranha.Data.StateList<T> ToStateList<T>(this IEnumerable<T> collection) {
		return new Piranha.Data.StateList<T>(collection);
	}
}
